...
<div class="banner-carousel banner-carousel-1 mb-0">
    <div class="banner-carousel-item" style="background-image:url(constra/images/slider-main/bg1.jpg)">
      <div class="slider-content">
          <div class="container h-100">
            <div class="row align-items-center h-100">
                <div class="col-md-12 text-center">
                  <h2 class="slide-title" data-animation-in="slideInLeft">17 Years of excellence in</h2>
                  <h3 class="slide-sub-title" data-animation-in="slideInRight">Optic Fiber Industry</h3>
    ...
    <div class="banner-carousel-item" style="background-image:url(constra/images/slider-main/bg2.jpg)">
    ...
    <div class="banner-carousel-item" style="background-image:url(constra/images/slider-main/bg3.jpg)">
